...
var handleSlimScroll = function () {
    ...
    $(".sidebar .nav > .has-sub > a").click(function () {
        var a = $(this).next(".sub-menu"), b = ".sidebar .nav > li.has-sub > .sub-menu";
    ...
    $("[data-click=sidebar-minify]").click(function (a) {
        a.preventDefault();
        var b = "page-sidebar-minified", c = "#page-container";
    ...
    return !panelActionRunning && (panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function (a) {
            ...
            if (0 !== $(c).length) {
                var e = $(b).offset().top, f = $(c).offset().top;
                d = f - e
            }
            if ($("body").hasClass("panel-expand") && $(b).hasClass("panel-expand")) $("body, .panel").removeClass("panel-expand"), $(".panel").removeAttr("style"), $(c).removeAttr("style"); else if ($("body").addClass("panel-expand"), $(this).closest(".panel").addClass("panel-expand"), 0 !== $(c).length && 40 != d) {
                var g = 40;
    ...
    "use strict";
    var a = $(".panel").parent("[class*=col]"), b = ".panel-heading", c = ".row > [class*=col]";
    $(a).sortable({
        handle: b, connectWith: c, stop: function (a, b) {
    ...
    $(document).scroll(function () {
        ...
        a.preventDefault(), $("html, body").animate({scrollTop: $("body").offset().top}, 500)
    })
    ...
    function a(a, b) {
        var d = (parseInt($(a).css("margin-left")), $(a).width()), e = $(a).find("li.active").width(),
            f = b > -1 ? b : 150, g = 0;
    ...
    function b(a, b) {
        var c = $(a).closest(".tab-overflow"), d = parseInt($(c).find(".nav.nav-tabs").css("margin-left")),
            e = $(c).width(), f = 0, g = 0;
        switch ($(c).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : g = e - d - 80, 0 != g && $(c).find(".nav.nav-tabs").animate({marginLeft: "-" + g + "px"}, 150, function () {
                    $(c).addClass("overflow-left")
                });
                break;
            case"prev":
                var h = -d;
                h <= e ? ($(c).removeClass("overflow-left"), g = 0) : g = h - e + 80, $(c).find(".nav.nav-tabs").animate({marginLeft: "-" + g + "px"}, 150, function () {
    ...
    function c() {
        $(".tab-overflow").each(function () {
            var b = $(this).width(), c = 0, d = $(this), e = b;
    ...
    $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function (b) {
        var c = b.originalEvent.touches[0] || b.originalEvent.changedTouches[0], d = c.pageY;
        ...
        if (b.preventDefault(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            var c = b.originalEvent.touches[0] || b.originalEvent.changedTouches[0], d = c.pageY, e = d - a;
        ...
        var c = $(this).closest("[data-scrollbar=true]"), d = $(window).height(),
            e = parseInt($("#sidebar").css("padding-top")), f = $("#sidebar").height();
        a = $(c).css("margin-top");
        var g = e;
    ...
    "use strict";
    function a(a, b) {
        var c = $(a).closest(".nav"), d = parseInt($(c).css("margin-left")), e = $(".top-menu").width() - 88, f = 0,
            g = 0;
        switch ($(c).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : g = e - d - 128, 0 != g && $(c).animate({marginLeft: "-" + g + "px"}, 150, function () {
                    $(c).find(".menu-control.menu-control-left").addClass("show")
                });
                break;
            case"prev":
                var h = -d;
                h <= e ? ($(c).find(".menu-control.menu-control-left").removeClass("show"), g = 0) : g = h - e + 88, $(c).animate({marginLeft: "-" + g + "px"}, 150, function () {
    ...
    function b() {
        var a = $(".top-menu .nav"), b = $(".top-menu .nav > li"), c = $(".top-menu .nav > li.active"),
            d = $(".top-menu"), f = (parseInt($(a).css("margin-left")), $(d).width() - 128),
            g = $(".top-menu .nav > li.active").width(), h = 0, i = 0;
